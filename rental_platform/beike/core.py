...
import config
from rental_platform.beike.client import BeiKeClient
from tools import utils
from var import crawler_type_var


class BeiKeCrawler(AbstractCrawler):
    context_page: Page
    beike_client: BeiKeClient
    browser_context: BrowserContext

    def __init__(self) -> None:
        self.index_url = "https://hz.zu.ke.com/zufang/rs/"
    ...
    async def start(self) -> None:
        ...
        async with async_playwright() as playwright:
            ...
            # Create a client
            # TODO: 是否可以修改成为依赖注入的方式
            self.beike_client = await self.create_xhs_client(httpx_proxy_format)
            ...
            utils.logger.info("[BeiKeCrawler.start] Xhs Crawler finished ...")
    ...
    async def launch_browser(
        ...
        utils.logger.info("[BeiKeCrawler.launch_browser] Begin create browser context ...")
    ...
    async def search(self) -> None:
        """Search for notes and retrieve their comment information."""
        utils.logger.info("[BeiKeCrawler.search] Begin search xiaohongshu keywords")
    ...
    #     utils.logger.info("[BeiKeCrawler.get_creators_and_notes] Begin get xiaohongshu creators")
    ...
    #             if not note_detail:
    #                 utils.logger.error(
    #                     f"[BeiKeCrawler.get_note_detail] Get note detail error, note_id: {note_id}")
    #                 return None
    #             note_detail.update({"xsec_token": xsec_token, "xsec_source": xsec_source})
    #             return note_detail
    #         except DataFetchError as ex:
    #             utils.logger.error(f"[BeiKeCrawler.get_note_detail] Get note detail error: {ex}")
    #             return None
    #         except KeyError as ex:
    #             utils.logger.error(
    #                 f"[BeiKeCrawler.get_note_detail] have not fund note detail note_id:{note_id}, err: {ex}")
    #             return None
    #
    # async def batch_get_note_comments(self, note_list: List[str]):
    #     """Batch get note comments"""
    #     if not config.ENABLE_GET_COMMENTS:
    #         utils.logger.info(f"[BeiKeCrawler.batch_get_note_comments] Crawling comment mode is not enabled")
    #         return
    #
    #     utils.logger.info(
    #         f"[BeiKeCrawler.batch_get_note_comments] Begin batch get note comments, note list: {note_list}")
    #     semaphore = asyncio.Semaphore(config.MAX_CONCURRENCY_NUM)
    #     task_list: List[Task] = []
    ...
    #     async with semaphore:
    #         utils.logger.info(f"[BeiKeCrawler.get_comments] Begin get note id comments {note_id}")
    ...
    #     utils.logger.info("[BeiKeCrawler.close] Browser context closed ...")
    #
    # async def get_notice_media(self, note_detail: Dict):
    #     if not config.ENABLE_GET_IMAGES:
    #         utils.logger.info(f"[BeiKeCrawler.get_notice_media] Crawling image mode is not enabled")
    #         return
